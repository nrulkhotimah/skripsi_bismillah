...
<table
    ...
    <tbody class="text-center">
        <div class="form-group">
            ...
            <textarea
                readonly=""
                class="form-control  <?php echo form_error('keluhan') ? 'is-invalid':'' ?>"
                id="keluhan"
                rows="3"
                name="keluhan"><?php echo $diagnosis->keluhan ?>
            </textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea
                ...
                id="catatan"
                rows="3"
                name="catatan"><?php echo $diagnosis->catatan ?>
            </textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea
                ...
                id="tugas_rumah"
                rows="3"
                name="tugas_rumah"><?php echo $diagnosis->tugas_rumah ?>
            </textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea
                ...
                id="saran"
                rows="3"
                name="saran"><?php echo $diagnosis->saran ?>
            </textarea>
        </div>
