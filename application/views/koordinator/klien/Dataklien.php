...
<table
    ...
    <tbody class="text-center">
        ...
        <tr>
            ...
            <td class="align-middle">
                <a href="<?php echo site_url('Koor/Dataklien/edit/'.$DataKlien->id_user) ?>" class="btn btn-link"><?php echo $DataKlien->nama ?></a>
            </td>
            ...
            <td class="align-middle">
                ...
                <?php else: ?>
                    <?php if ($DataKlien->status_konsel == "selesai"): ?>
                        <a class="btn btn-info" href="<?php echo site_url('Koor/Dataklien/detailcatkonsel/'.$diagnosis[$DataKlien->id_user]['id']) ?>">Open</a>
                    <?php else: ?>
