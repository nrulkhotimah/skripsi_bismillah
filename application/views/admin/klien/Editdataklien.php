                ...
                <div id="content">
                    <div class="jumbotron">
                        ...
                        <div style="float:right">
                            <span class="title font-weight-bold">EDIT DATA KLIEN</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <form>
                            <table class="col-md-8">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-md-2 col-form-label">No.</label>
                                    <div class="col-md-10">
                                        <input
                                            type="email"
                                            class="form-control"
                        ...
                        <div class="modal-footer">
                            <a href="<?php echo site_url('Admin/dataKlien')?>">
