...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item btn-link">
    <a href="<?php echo site_url('Admin/Pendaftaran/pilih_psikolog/'.$id_klien) ?>"> Pilih psikolog</a>
...
<tbody class="text-center">
    ...
    <tr>
        ...
        <?php else: ?>
            <a
                href="<?php echo base_url("admin/pendaftaran/simpan_jadwal/".$id_klien."/".$id_penjadwalan."/".$value) ?>"
